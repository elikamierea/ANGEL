...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  createProjectFolder: (payload) => ipcRenderer.invoke('project:createFolder', payload),
  moveProjectPaths: (payload) => ipcRenderer.invoke('project:movePaths', payload),
  copyProjectPaths: (payload) => ipcRenderer.invoke('project:copyPaths', payload),
